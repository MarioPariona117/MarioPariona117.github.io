...
function splitTable(lines) {
  ...
  // Whether the first row is a heading is stated, not guessed: a markdown
  // delimiter row after it says so. Guessing got it wrong both ways — a table
  // that simply starts with data had its first entry styled as a heading and
...
function renderTextBlock(text) {
  ...
  for (const para of (text || "").split(/\n\s*\n/).map((x) => x.trim()).filter(Boolean)) {
    ...
    if (table) {
      ...
      out.push(
        `<div class="reader-table-wrap"><table class="reader-table">` +
          (head
            ? `<thead><tr>` + head.map((c) => `<th>${renderInline(escapeHtml(c))}</th>`).join("") + `</tr></thead>`
            : "") +
          `<tbody>` +
          body
            .map((r) =>
...
const SEED_LIBRARY_ENTRIES = [
  ...
  },
  {
    ...
    source: "St. Teresa of Ávila, The Interior Castle, 1577",
    author: "St. Teresa of Ávila",
    authorNote: "written in under six months, in the middle of the persecution of her reform",
    related: ["The Three Ways", "The Dark Night", "Consolation and Desolation", "The Cell of Self-Knowledge", "The Theological Virtues"],
    relatedSaints: ["teresa-of-avila", "john-of-the-cross"],
    year: "1577",
    origin: "Carmelite — Spain",
    liturgical: "",
    feastDay: "",
    originalLanguage: "",
    favorite: false,
    body:
      "THE IMAGE\n\n\"I began to think of the soul as if it were a castle made of a single diamond or of very clear crystal, in which there are many rooms, just as in Heaven there are many mansions.\"\n\nGod is in the innermost room. The soul is the castle — not a visitor to it — and most people, she says, live in the outer courtyard of a place they own, never having wondered what is inside.\n\nTHE SEVEN\n\n| Mansion | What is happening |\n| --- | --- |\n| First | The soul enters at all. Prayer begins, and with it self-knowledge, which she calls the room you never outgrow. |\n| Second | War. Having begun, the soul is now fought for; this is the hardest place to persevere. |\n| Third | Order, and the danger in it — a settled, dutiful life, and aridity in prayer. Many stop here. |\n| Fourth | The turn. The supernatural begins: consolations that arise from our own effort give way to delights God simply gives. |\n| Fifth | The prayer of union, brief and unmistakable. The silkworm dies and the butterfly comes out. |\n| Sixth | The longest and hardest: wounds of love, locutions, raptures, visions — and the heaviest trials of the whole road. |\n| Seventh | Spiritual marriage, in the innermost room. And the fruit is not repose but work — Martha and Mary keeping house together. |\n\nTWO THINGS PEOPLE GET WRONG\n\nThe rooms are not a ladder you leave behind. She is explicit that the soul must keep returning to the first room, self-knowledge, however far in it goes — the castle has many rooms and you may move about them.\n\nAnd the end is not withdrawal. The seventh mansion produces works: Martha and Mary together, which is her answer to anyone who thinks the point of the interior life is to be left alone in it.\n\nWHERE TO READ MORE\n\n**The Interior Castle**, full text, free. The Fourth Mansions are the ones to read first if you read only one.\nhttps://www.ccel.org/ccel/teresa/castle2.toc.html",
    background:
      "Written in 1577, in under six months, while she was under effective house arrest and her reform was being dismantled around her. She was in her sixties and had been ordered to write it; she says she would rather have been spinning.\n\nThe distinction that makes the Fourth Mansions famous is between contentos and gustos — consolations that begin in our own effort and end in God, reached by meditation as water reaches a fountain through aqueducts, and delights that begin in God and are simply given, welling up like a spring at its source. Her question is about origin, not intensity, and it is the reason she warns against straining after sweetness: what can be manufactured is by definition not the thing that matters.\n\nRead alongside John of the Cross, who was her collaborator and describes the same road in a darker register. Where she counts rooms, he counts nights.",
  },
  {
    ...
    source: "St. Catherine of Siena, The Dialogue, ch. 23",
    author: "St. Catherine of Siena",
    authorNote: "her expansion of John 15",
    related: ["The Bridge", "The Cell of Self-Knowledge", "The Twelve Fruits of the Holy Spirit", "The Works of Mercy"],
    relatedSaints: ["catherine-of-siena"],
    year: "1378",
    origin: "Dominican — Siena",
    liturgical: "",
    feastDay: "",
    originalLanguage: "",
    favorite: false,
    body:
      "THE IMAGE\n\n\"Every rational creature has her own vine, that is the vine of her soul; she labours this vine by means of her will and free choice in time, that is to say, while she lives, but when the time is past she can do no more work, neither good nor evil.\"\n\nChrist is the true vine and we are the branches — Catherine is expanding John 15 — but she adds a second thing: each of us is also a vinedresser, with a plot that is ours and nobody else's.\n\nTHREE THINGS SHE SAYS ABOUT IT\n\n| It cannot be taken from you | \"Neither the devil nor any other creature can take it from her without her consent.\" The one thing that can lose your vine is your own agreement. |\n| You were given a knife at baptism | \"There was given her then a pruning-knife with the blades of love of virtue and hatred of sin.\" Two blades, and it only cuts with both. |\n| The work is time-limited | You labour it \"while you have the time.\" Catherine says this plainly and often; it is not morbid, it is the reason the work is worth anything. |\n\nAND IT IS GRAFTED\n\nThe vine of your soul is not freestanding. It is \"grafted upon the vine of the Holy Church,\" and the priests are labourers set to work in it alongside you — their task \"to extract the thorns of mortal sin, and to plant in you the seed of grace.\"\n\nSo there are three growers in one plot: you, with free will; the ministers, with the sacraments; and the Husbandman, who is the Father. What the image rules out is the idea that your soul is a private garden.\n\nWHERE TO READ MORE\n\n**The Dialogue**, ch. 23 — \"How we are all labourers of God in the vineyard of the Holy Church; and how each man has his own vine.\"\nhttps://archive.org/details/seraphicvirginca00cathuoft",
    background:
      "John 15 gives the vine and the branches. Catherine's addition is the labour: a branch is passive, and a vinedresser is not, so she has us be both at once — living off the vine and working a plot of it.\n\nThe pruning-knife with two blades is the detail worth keeping. Love of virtue without hatred of sin produces a sentimental religion that never cuts anything; hatred of sin without love of virtue produces the opposite and worse fault. She gives one tool with both edges, handed over at baptism, and says the cutting is yours to do.",
  },
  {
    ...
    source: "St. Catherine of Siena, The Dialogue",
    author: "St. Catherine of Siena",
    authorNote: "the phrase is hers and recurs throughout the Dialogue and the Letters",
    related: ["The Bridge", "The Vine of Your Own Soul", "The Examen", "The Three Powers of the Soul", "Humility Is Nothing But Truth"],
    relatedSaints: ["catherine-of-siena"],
    year: "1378",
    origin: "Dominican — Siena",
    liturgical: "",
    ...
    favorite: false,
    body:
      "THE CELL\n\nA room you can be in anywhere. Catherine spent three years enclosed in an actual cell in her father's house, and then left it for a life of travelling, letter-writing and confronting popes — and kept the cell. What she means is a habit of dwelling in the truth about yourself, carried about, entered at will.\n\nThe soul \"begins by exercising herself, for a certain space of time, in the ordinary virtues, remaining in the cell of self-knowledge, in order to know better the goodness of God towards her.\"\n\nNote the reason given. Self-knowledge is not for its own sake, and not to produce an accurate inventory of faults. It is there so that God's goodness can be measured against something.\n\nTHE HALF THAT IS ALWAYS DROPPED\n\nSelf-knowledge on its own does not humble a person. It crushes them. Catherine says so precisely, in the image of the circle:\n\n\"This knowledge of thyself and of Me is found in the earth of true humility, which is as wide as the diameter of the circle, that is as the knowledge of self and of Me — for, otherwise, the circle would not be without end and beginning, but would have its beginning in knowledge of self, and its end in confusion, if this knowledge were not contained in Me.\"\n\nA circle drawn from self-knowledge alone does not close. It starts in looking at yourself and ends in confusion. The two knowledges are one ground, and the ground is called humility.\n\nWHAT IT IS NOT\n\nIt is not introspection, which has no floor. It is not scrupulosity, which is self-knowledge with God's goodness removed. And it is not a stage to be completed: the soul in the Dialogue keeps returning to the cell, including when God seems to have withdrawn — \"she does not, on that account, look back, but perseveres with humility in her exercises, remaining barred in the house of self-knowledge,\" waiting there. Not idly: \"in watching and continued prayer.\"\n\nWHERE TO READ MORE\n\n**The Dialogue**, Thorold's translation, 1896. The cell recurs throughout rather than sitting in one chapter, which is itself the point.\nhttps://archive.org/details/seraphicvirginca00cathuoft",
    background:
      "Catherine's two cells are usually quoted from her letters, where she tells a correspondent to build an inner cell and never leave it. The Dialogue gives the doctrine behind the advice, and the doctrine is stricter than the slogan: the cell has two occupants, and a cell containing only yourself is a worse place to be than the world.\n\nThis is the safeguard that makes the practice usable. Everything modern that resembles it — self-examination, journalling, taking stock — tends to produce either complacency or despair, because it measures the self against the self. Catherine's circle has two arcs and closes only when both are drawn.\n\nWorth reading beside the Examen, which is the same instinct given a method and a time of day, and beside the three powers of the soul, which is what the cell contains.",
  },
  {
    title: "The Bridge",
    kind: "teaching",
    ...
    source: "St. Catherine of Siena, The Dialogue, ch. 23-26",
    author: "St. Catherine of Siena",
    authorNote: "dictated in ecstasy to her secretaries, 1378",
    related: ["The Cell of Self-Knowledge", "The Vine of Your Own Soul", "Love Undefiled", "The Three Ways", "The Five Wounds"],
    relatedSaints: ["catherine-of-siena"],
    year: "1378",
    origin: "Dominican — Siena",
    liturgical: "",
    ...
    favorite: false,
    body:
      "THE IMAGE\n\nThe road to heaven was broken by sin, so God made a bridge of His own Son. Not a rescue from a distance: a body laid across the gap.\n\n\"I have made a Bridge of My Word, of My only-begotten Son.\"\n\nIt is raised high and still joined to the earth — raised when He was lifted on the Cross, and joined because the divine nature stayed \"united and kneaded into one thing\" with our humanity. The water running underneath cannot touch it: in Him there was no venom of sin.\n\nTHREE STEPS\n\n| Step | What it is | What happens there |\n| --- | --- | --- |\n| The Feet | \"The feet of the soul, signifying her affection, are the first step, for the feet carry the body as the affection carries the soul.\" | \"Lifting her feet from the affections of the earth, the soul strips herself of vice.\" |\n| The Side | The pierced side, \"Which manifests to thee the secret of His Heart\" — the soul gazes into the open Heart \"with the eye of the intellect, and finds It consumed with ineffable love.\" | \"She fills herself with love and virtue.\" |\n| The Mouth | The third step, which \"still retains the great bitterness He tasted, when He was given gall and vinegar to drink.\" | \"She finds peace from the terrible war she has been waging with her sin.\" |\n\nTwo of the steps were made from the wood of the Cross. The third is the taste of the gall.\n\nWHY THE ORDER CANNOT BE REVERSED\n\nBecause each step is the condition of the next. You cannot gaze into the Heart while your affection is still fastened to what it was fastened to; the feet have to move first. And peace comes last, not first — it is what is found at the mouth, after the stripping and the filling, not a mood you begin with.\n\nCatherine is describing the same three stages the tradition calls purgative, illuminative and unitive, but hung on a body rather than drawn as a ladder. The difference matters: a ladder is something you climb by your own effort, and a bridge is something someone else laid down.\n\nWHERE TO READ MORE\n\n**The Dialogue**, Thorold's translation, 1896 — chapters 23 to 26 are the bridge. Free, full text, and shorter than its reputation.\nhttps://archive.org/details/seraphicvirginca00cathuoft",
    background:
      "Catherine dictated the Dialogue in 1378, in ecstasy, to secretaries who wrote as she spoke — which is why the images pile up and sometimes collide. Her translator notes, half in apology, that she \"introduces a metaphor and forgets it; the sea, a vine, and a plough will often appear in the same sentence.\"\n\nThe bridge is the exception. It is sustained over several chapters and worked out in detail, and it is the organising image of the whole book: everything else in the Dialogue is a description of somebody on it, under it, or refusing to step on.\n\nThe detail most often lost in retellings is that the bridge is not offered as a route you may take if you wish. God says the road was broken; there is no other crossing. And the reason it must be walked rather than admired is given plainly: \"It would not be enough for your salvation that My Son should have made you this Bridge, unless you walk thereon.\"",
  },
  {
    title: "The Angelus",
    kind: "prayer",
  ...
  },
  {
    ...
    source: "Fr. Raphael Simon, O.C.S.O. — attributed almost everywhere to St. Augustine",
    author: "Fr. Raphael Simon, O.C.S.O.",
    authorNote: "not St. Augustine; see background",
    related: ["Late Have I Loved You", "Use Words If Necessary", "Not So Much Praying as Become Prayer"],
    relatedSaints: ["augustine"],
    year: "in circulation by 1964",
    origin: "Trappist — 20th century",
    liturgical: "",
    feastDay: "",
    originalLanguage: "",
    favorite: false,
    body:
      "To fall in love with God is the greatest romance; to seek Him the greatest adventure; to find Him, the greatest human achievement.\n\nWHERE TO READ MORE\n\n**A fact-check of the attribution**, with the 1964 citation.\nhttps://fauxtations.wordpress.com/2015/08/28/st-augustine-romance-adventure-achievement/",
    background:
      "Attributed to St. Augustine on cards, posters and quotation sites, sometimes with a specific claim that it comes from the Confessions. It does not, and it is not his.\n\nIt is Fr. Raphael Simon, a Trappist of the twentieth century — a psychiatrist and convert from Judaism who entered Spencer Abbey. The line is traceable in his name to a 1964 Newsweek piece, and a version of it appears in his Formation of the Priest.\n\nThe entry is here rather than discarded for the same reason as the other misattributions in this library: the line is genuinely good, it is going to keep appearing under Augustine's name, and the useful thing is to know whose it is. Augustine's own sentence in this territory is in the Confessions and is better — \"Late have I loved you, beauty so old and so new\" — and it has the advantage of being his.",
  },
  {
    ...
    source: "St. John Vianney, catechism on Communion, in Monnin's Esprit du Curé d'Ars (1864)",
    author: "St. John Vianney",
    authorNote: "the familiar second half is not in the instruction — see background",
    related: ["He Would Die of Love", "Anima Christi", "Tantum Ergo", "Panis Angelicus"],
    relatedSaints: ["john-vianney"],
    year: "recorded 1864",
    origin: "Ars, France",
    liturgical: "",
    feastDay: "",
    ...
    favorite: false,
    body:
      "Il n'y a rien de si grand, mes enfants, que l'Eucharistie! Mettez toutes les bonnes œuvres du monde contre une communion bien faite: ce sera comme un grain de poussière devant une montagne.\n\nThere is nothing so great, my children, as the Eucharist! Put all the good works in the world against one communion well made: it will be like a grain of dust before a mountain.\n\nWHERE TO READ MORE\n\n**The catechism on Communion** — the instruction this comes from, in French.\nhttps://le-petit-sacristain.blogspot.com/2019/08/catechisme-du-saint-cure-d-ars-sur-la-communion.html",
    background:
      "The line is usually quoted as \"There is nothing so great as the Eucharist. If God had something more precious, He would have given it to us.\" The first sentence is his, word for word, from the catechism on Communion. The second is not in that instruction, nor in the one on the Mass; it circulates in French as well as English, so it is not a translator's invention, but it could not be placed in a period text.\n\nWhat he actually said next is better, and sharper: put every good work in the world on one side and a single communion well made on the other, and it is dust against a mountain. That is a harder claim than the one it gets replaced by — it is not saying the Eucharist is very precious, it is saying the scale of comparison is wrong.\n\nThe source is Monnin's Esprit du Curé d'Ars (1864), the collection of his catechetical instructions taken down by hearers. Vianney wrote almost nothing himself.",
  },
  {
    ...
    source: "St. John Vianney, catechism on the Holy Sacrifice of the Mass, in Monnin's Esprit du Curé d'Ars (1864)",
    author: "St. John Vianney",
    authorNote: "usually quoted in a changed form — see background",
    related: ["There Is Nothing So Great as the Eucharist", "Prayer Before Mass", "Anima Christi", "The Twelve Fruits of the Holy Spirit"],
    relatedSaints: ["john-vianney"],
    year: "recorded 1864",
    origin: "Ars, France",
    liturgical: "",
    ...
    favorite: false,
    body:
      "Si l'homme connaissait bien ce mystère, il mourrait d'amour.\n\nIf man understood this mystery well, he would die of love.\n\nAnd in the same instruction, of the priest at the altar:\n\nOh! que le prêtre est quelque chose de grand! S'il se comprenait, il mourrait.\n\nOh, how great a thing a priest is! If he understood himself, he would die.\n\nWHERE TO READ MORE\n\n**The catechism on the Holy Sacrifice of the Mass** — the instruction this comes from, in French.\nhttps://le-petit-sacristain.blogspot.com/2019/08/catechisme-du-saint-cure-d-ars-sur-le-saint-sacrifice-de-la-messe.html",
    background:
      "What circulates in English is \"If we really understood the Mass, we would die of joy.\" That is not quite what he said, and the difference is the whole interest of the line.\n\nHe says love, not joy. And he says \"this mystery\", not \"the Mass\" — the sentence sits inside an instruction on the Sacrifice, so the referent is the same, but the register is not. Dying of joy is a pleasant hyperbole. Dying of love is the tradition's actual claim about what is happening at the altar, and it is the reason the second sentence, about the priest, is so alarming: he does not say the priest would die of joy either.\n\nVianney wrote almost nothing. Everything we have is reported speech, taken down by hearers and collected by the Abbé Monnin in the Esprit du Curé d'Ars of 1864 — his catechetical instructions, homilies and conversation. So the wording is at one remove even at its best, which is worth knowing before treating any Vianney quotation as verbatim. This one is at least traceable to the collection; the English version in circulation is not traceable to anything.",
  },
  {
